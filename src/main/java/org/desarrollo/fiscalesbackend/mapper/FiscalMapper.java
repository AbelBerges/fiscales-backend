...
import org.desarrollo.fiscalesbackend.dto.FiscalRequestDTO;
import org.desarrollo.fiscalesbackend.dto.FiscalResponseDTO;
import org.desarrollo.fiscalesbackend.model.*;
...
public class FiscalMapper {
    ...
    public static FiscalResponseDTO aEntidadResponseDTO(Fiscal fiscal) {
        if (fiscal.getJornada() != null) {
            System.out.println("Entra acá y muestra el idJornada " + fiscal.getJornada().getIdJornada());
        }
        return new FiscalResponseDTO(
                ...
                fiscal.isActivo(),
                fiscal.getEstablecimientoVoto().getIdEstablecimiento() != null ? fiscal.getEstablecimientoVoto().getIdEstablecimiento() : null,
                fiscal.getDireccion().getCalle().getIdCalle() != null ?
                        fiscal.getDireccion().getCalle().getIdCalle() : null,
                fiscal.getDireccion().getAltura(),
                fiscal.getDireccion().getTipoPiso().getIdPiso() != null ?
                        fiscal.getDireccion().getTipoPiso().getIdPiso() : null,
                fiscal.getDireccion().getTipoDepartamento().getIdDepartamento() != null ?
                        fiscal.getDireccion().getTipoDepartamento().getIdDepartamento() : null,
                fiscal.getJornada().getIdJornada() != null ?
                        fiscal.getJornada().getIdJornada() : null,
